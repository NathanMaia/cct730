...
public class Principal {
	...
	/**
	 * Metodo principal da aplicacao (responsável pela execução do programa)
	 * @param args
	 * @throws Exception
	 * 
	 * @return void
	...
	private static int[][] getMatriz(String nomeArquvivo) throws IOException {
		...
		//Obtendo a primeira linha do arquivo (que contém a dimensão da matriz)
	...
	/**
	 * Método responsável por abrir um buffer com o arquivo
	 * 
